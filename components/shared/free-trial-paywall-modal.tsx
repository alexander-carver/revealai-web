...
export function FreeTrialPaywallModal() {
  ...
  const handleStartAccess = async () => {
    ...
    trackCTAClick(
      isWeekly
        ? "Promotional Paywall - Weekly Access"
        : "Promotional Paywall - Annual Access"
    );
  ...
  const selectedPlanLabel = isWeeklySelected ? "Weekly" : "Annual";

  return (
    <div
      className="fixed inset-0 z-50 flex items-end justify-center bg-black/60 pt-10 sm:pt-16 animate-fade-in"
          ...
          <div className="relative z-10 px-4 pb-3 pt-4 min-[390px]:px-5 min-[390px]:pb-4 min-[390px]:pt-5 sm:px-8 sm:py-10 flex-1 overflow-y-auto">
            ...
            <div className="mb-5 flex flex-col items-center sm:mb-8">
              ...
              <div className="text-center">
                <span className="text-sm text-gray-500 sm:text-base">
                  Billed today at {formatUsd(selectedPrice)}/{selectedCadence}
                </span>
              </div>
            </div>
            ...
            >
              {isLoading ? (
                ...
                <>
                  Unlock {isWeeklySelected ? "Weekly" : "Annual"} Access
