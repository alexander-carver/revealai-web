  ...
  if (enformionId === "emma-smith") {
    return {
      ...
      profile: {
        ...
        properties: [
          {
            address: "1420 Wynkoop St Unit 4B",
            city: "Denver",
            state: "CO",
            zip: "80202",
  ...
  if (enformionId === "kyle-anderson") {
    return {
      ...
      profile: {
        ...
        phones: [
          { number: "(512) 555-0122", type: "Mobile", carrier: "AT&T", isCurrent: true }
        ],
        emails: [
        ...
        liens: [
          {
            ...
            amount: 4500,
            creditor: "State of Illinois Dept of Revenue",
            type: "State Tax Lien"
          }
        ],
        employment: [
          {
            company: "Elevate Fitness ATX",
